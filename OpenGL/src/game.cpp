...
void Game::Init()
{
    ...
    // load textures
    ResourceManager::LoadTexture("res/textures/bg.jpg", false, "background");
    ResourceManager::LoadTexture("res/textures/amongu.png", true, "face");
    ResourceManager::LoadTexture("res/textures/block2.png", false, "block");
    ResourceManager::LoadTexture("res/textures/block.png", false, "block_solid");
...
{
    Ball->Move(dt, this->Width); // move ball
...
// precises AABB collision detection algorithm
